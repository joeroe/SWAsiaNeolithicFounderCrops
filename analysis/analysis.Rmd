...
flora %>% 
  ...
  gt(caption = "Occurrence of all taxa in Neolithic assemblages") %>% 
  ...
  tab_footnote("Founder crops in bold.", cells_column_labels(taxon)) ->
  occ_all
...
The following table shows the ubiquity of the founder crop species in assemblages broken down by period, i.e. for each period, the number of assemblages where *N* distinct founder species are present, for varying values of *N*.
