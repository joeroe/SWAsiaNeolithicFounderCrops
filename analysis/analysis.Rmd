...
The full *research compendium* containing the data and R code needed to reproduce the analysis can be accessed at <https://github.com/joeroe/SWAsiaNeolithicFounderCrops>).
...
We are now in a position to inspect the geographical and temporal coverage of the data.
