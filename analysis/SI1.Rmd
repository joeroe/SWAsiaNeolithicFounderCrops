---
title: 'Supplementary Information 1: Meta-analysis of Neolithic archaeobotanic assemblages from southwest Asia'
author:
  - first_name: "Joe"
    last_name: "Roe"
    url: https://joeroe.io
...
We also used Colledge et al.'s [-@Colledge2004; see also [@Shennan2007] compilation of European data.
Since this data did not need to be formally incorporated into the rest of the analyses, we simply imported Colledge et al.'s dataset as is, excluding non-European countries (for completeness Cyprus was included in both the European and Southwest Asian datasets).
It includes `r n_assemb_europe` assemblages from `r n_site_europe` Neolithic sites across Europe, but only presence data.

We used the European data to quantitatively assess early evidence for translocation of certain crops from Southwest Asia to Europe, reported in table X of the main text.
