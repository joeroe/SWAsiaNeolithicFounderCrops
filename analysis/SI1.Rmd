...
flora_phases |> 
  ...
  # bind_rows(tribble(
  #   ~site_name, ~period, ~latitude, ~longitude,
  #   "Ahihud", 
  #   "Asikli Höyük", 
  #   "Demirköy", 
  #   "Dhra'", 
...
ggsave(here("analysis/figures/fig1.eps"), width = 174, height = 174,
       units = "mm")
ggsave(here("analysis/figures/fig1.png"), width = 174, height = 174,
       units = "mm", dpi = 300)
```
